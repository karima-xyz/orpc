...
import type { OpenAPIV3 as OpenAPI } from '@orpc/contract'
...
/**
 * @internal
 * @TODO needs to be done properly. 3.0.x have a very different deviation from JSONSchema
 */
export function toOpenAPISchema(schema: JSONSchema): OpenAPI.SchemaObject & object {
  return schema === true
    ...
    : schema === false
      ? { not: {} }
      : convertSync(schema) as OpenAPI.SchemaObject
}
